...
public class TreeConfig {
    ...
    public static final long TIME_PER_GROWTH_STAGE_MS = 60_000; // 60 giây / giai đoạn
    
    /** Thời gian (ms) để cây mọc lại từ gốc (stage 0) lên stage 1 */
    public static final long REGROW_TIME_MS = 30_000; // 30 giây
    ...
    /** Stage tối đa mà cây có thể phát triển (Stage 2 = cây trưởng thành) */
    public static final int TREE_MAX_GROWTH_STAGE = 2;
